...
try:
    ...
    if connection1.is_connected():
        ...
        cursor.execute("SELECT count(*) FROM information_schema.tables WHERE table_schema = '{}'".format(db1_name))
    ...
    if connection2.is_connected():
        ...
        cursor.execute("SELECT count(*) FROM information_schema.tables WHERE table_schema = '{}'".format(db2_name))
